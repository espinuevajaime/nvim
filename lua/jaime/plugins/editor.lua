...
return {
	...
	-----------------------------------------------------------------------------
	{
		...
		init = function()
			...
			vim.api.nvim_create_autocmd('StdinReadPre', {
				group = vim.api.nvim_create_augroup('jaime_persisted', {}),
				callback = function()
	...
	-----------------------------------------------------------------------------
	{
		...
		config = function(_, opts)
			...
			vim.api.nvim_create_autocmd('FileType', {
				group = vim.api.nvim_create_augroup('jaime_illuminate', {}),
				callback = function()
	...
	-----------------------------------------------------------------------------
	{
		...
		init = function()
			vim.api.nvim_create_autocmd('FileType', {
				group = vim.api.nvim_create_augroup('jaime_outline', {}),
				pattern = 'Outline',
				callback = function()
